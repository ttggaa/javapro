...
public class AlipaySubmit {
     ...
     */
    protected static final String ALIPAY_GATEWAY_NEW = "https://mapi.alipay.com/gateway.do?";
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
    	String prestr = AlipayCore.createWebLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
    	String mysign = "";
     ...
     * @return 要请求的参数数组
     */
    protected static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
    	//除去数组中的空值和签名参数
        ...
        sPara.put("sign_type", AlipayConfig.md5_sign_type);
