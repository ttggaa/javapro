...
import com.kariqu.zwsrv.app.pay.tenpay.Configure;
import com.kariqu.zwsrv.app.pay.tenpay.RandomStringGenerator;
import com.kariqu.zwsrv.app.pay.tenpay.Signature;
...
public class WXPayReqData {
     ...
     */
    public WXPayReqData(String appId,String mchId,String body,String attach,String outTradeNo,int totalFee,String spBillCreateIP,String timeStart,String timeExpire){
...
//        if (type.equals(Configure.getTRADE_TYPE_JS())) {
//        	sign = Signature.getJsSign(toMap());
//        }
//
//
//        setSign(sign);//把签名数据设置到Sign这个属性中
    ...
    public void generateSign() {
    	String sign = Signature.getSign(toMap());
      if (this.getTrade_type().equals(Configure.getTRADE_TYPE_JS())) {
      	sign = Signature.getJsSign(toMap());
      } 
