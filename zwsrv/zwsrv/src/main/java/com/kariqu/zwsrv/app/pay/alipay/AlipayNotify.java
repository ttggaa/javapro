...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params) {
	    ...
	    boolean isSign = (getSignVeryfy(params, sign) || getMD5ignVeryfy(params,sign));
	    
        //写日志记录（若要调试，请取消下面两行注释）
        String sWord = "responseTxt=" + responseTxt + "\n isSign=" + isSign + "\n ResponseParam is：" + AlipayCore.createLinkNotifyString(params);
        logger.info(sWord);
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        String preSignStr = AlipayCore.createLinkNotifyString(sParaNew);

        //获得签名验证结果
        boolean isSign = false;
        String encodeSign = encode(sign, "utf-8");
        System.out.println("encodeSign is: " + encodeSign);
     ...
     * @return 生成的签名结果
     */
	private static boolean getMD5ignVeryfy(Map<String, String> Params, String sign) {
    	//过滤空值、sign与sign_type参数
    	Map<String, String> sParaNew = AlipayCore.paraFilter(Params);
        //获取待签名字符串
        String preSignStr = AlipayCore.createWebLinkString(sParaNew);
        //获得签名验证结果
        boolean isSign = false;
