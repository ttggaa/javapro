...
//	[微信支付]:
    ...
    public static String getSign(Object o) throws IllegalAccessException {
        ...
        logger.info("MD5 Sign Result:{}" + result);
        return result;
    }
    ...
    public static String getSign(Map<String,Object> map){
        ...
        String result = sb.toString();
        //trade_type 分为JS和App两种情况
        String tradeType = map.get("trade_type") == null ? Configure.getTRADE_TYPE_APP() : map.get("trade_type").toString();
        String secretKey = Configure.getKey();
        if(Configure.getTRADE_TYPE_JS().equals(tradeType)) {
            secretKey = Configure.getJs_key();
        }
    ...
    public static String getJsSign(Map<String,Object> map){
        ...
        String result = sb.toString();
        result += "key=" + Configure.getJs_key();
        //Util.log("Sign Before MD5:" + result);
        result = MD5.MD5Encode(result).toUpperCase();
        //Util.log("Sign Result:" + result);
        return result;
    ...
    public static boolean checkIsSignValidFromResponseString(String responseString) throws ParserConfigurationException, IOException, SAXException {
        ...
        if (map.get("sign")!=null) {
            ...
            logger.info("[微信支付]:恭喜，API返回的数据签名验证通过!!!");
            return true;
        }
        else {
            return false;
     ...
     * @throws SAXException
     */
    public static boolean checkIsJsSignValidFromResponseString(String responseString) throws ParserConfigurationException, IOException, SAXException {
        ...
        map.put("sign","");
        //将API返回的数据根据用签名算法进行计算新的签名，用来跟API返回的签名进行比较
        String signForAPIResponse = Signature.getJsSign(map);
