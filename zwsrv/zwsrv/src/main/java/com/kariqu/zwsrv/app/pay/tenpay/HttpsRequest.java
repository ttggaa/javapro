...
//        FileInputStream instream = new FileInputStream(new RelayFile(Configure.getCertLocalPath()));//加载本地的证书进行https加密传输
//        try {
...
//        postDataXML.replace("xml", xmlObj.getClass().);
        
        logger.info("[微信支付]:API，POST过去的数据是：{}",postDataXML);
