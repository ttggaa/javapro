...
import com.kariqu.wssrv.app.tcp.SerialTcpServerConfig;
import com.kariqu.wssrv.app.ws.WebSocketConfigApp;
import com.kariqu.wssrv.app.ws.WebSocketConfigSrv;
...
@ComponentScan({"com.kariqu.zwsrv.thelib.persistance","com.kariqu.zwsrv.thelib","com.kariqu.wssrv.app.transaction","com.kariqu.wssrv.app"})
public class Application {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        GameRoomManager.getInstance();
        SerialTcpDeviceManager.getInstance();
        ...
        applicationShutdown.setTcpServer(tcpServer);
        applicationShutdown.setWsSrvServer(srvServer);
        applicationShutdown.setWsAppServer(appServer);
        applicationShutdown.setSpringContext(context);
